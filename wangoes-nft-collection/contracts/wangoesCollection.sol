...
contract WangoesCollection is ERC721URIStorage, Ownable {
    ...
    constructor() ERC721("WangoesCollection", "NFT") {}
    ...
    function checkWithdrawMoney() external view returns(uint256){
